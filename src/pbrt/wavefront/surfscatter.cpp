        ...
        PBRT_CPU_GPU_LAMBDA(const MaterialEvalWorkItem<ConcreteMaterial> w) {
            ...
            auto addSampleToShadowRayReservoir = [&]() {
                ...
                if (IsNonSpecular(flags)) {
                    ...
                    DIReservoir dstReservoir = imageState.diReservoir[curPixelNumber];
                    ...
                    imageState.diReservoir[curPixelNumber] = dstReservoir;
            ...
            if (ls) {
                ...
                shadowRayQueue->Push(ShadowRayWorkItem{ray, 1 - ShadowEpsilon, w.lambda,
                                                       Ld, r_u, r_l, w.pixelIndex});
